...
To answer what are the trends in cancer incidence and air quality over time, we need: 
...
3. Heatmaps: Use heatmaps to show state-wise differences or year-wise changes.

To answer how do air quality and cancer rates vary across states, we need:
...
After knowing what geographical areas have poor air quality, we need to explore whether certain cancer subtypes show a stronger association with poor air quality. We would compare the time series line we got for cancer incidence with the line we got for air condition. Make scatter plots to visualize the relationship between air quality indices and cancer rates.

Finally to answer whether there is a statistically significant correlation between long-term exposure to poor air quality, we will first draw scatter plots can show the relationship between two continuous variables cancer incidence rates and air quality levels. And then, we will perform hypothesis testing using Pearson's test and get a conclusion based on p-value. 
